...
{
    [TestClass]
    public class RentalByIdHandlerTests
    {
        ...
        public async Task TestContextInputsCustomerIdEqualsZeroFailed()
        {
            ...
            _rentalRepositoryMock?.Setup(x => x.GetById(It.IsAny<int>())).Returns(() => null); // should fail once here           

            var handler = new RentalByIdHandler(_logger.Object, _configuration.Object, _rentalRepositoryMock?.Object,                
